...
- Register:
```json
{ "type":"register", "agent_id":"rt1", "secret":"...", "version":"0.1.0", "directives_hash":"..." }
```
...
- Exec:
```json
{ "type":"exec", "job":"<uuid>", "directive":"ping", "target":"203.0.113.1", "timeout_ms":30000 }
```
...
- Output chunk:
```json
{ "type":"chunk", "job":"<uuid>", "seq":1, "stream":"stdout", "data":"..." }
```
